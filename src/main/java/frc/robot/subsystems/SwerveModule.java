...
public class SwerveModule extends SubsystemBase {
    ...
    public SwerveModule(int driveMtrId, int steerMtrId, int canCoderId, Rotation2d offset) {
        ...
        driveConfig 
            .inverted(false) //Changed from true to false 02/04
        ...
        steerConfig 
            .inverted(true) //Changed from false to true 02/04
            .idleMode(IdleMode.kCoast); //Changed from brake to Coast 02/04
        steerConfig.encoder
